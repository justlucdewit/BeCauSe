        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ForCompanyId = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    PlacedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyId = table.Column<int>(type: "integer", nullable: false),
                    UserMade = table.Column<bool>(type: "boolean", nullable: false),
                    SpecialPageId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItemSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderItemSettings_OrderItems_OrderItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemSettings_OrderItemId",
                table: "OrderItemSettings",
                column: "OrderItemId");
